...
/**
 * Example of using a JCEKS keystore with KeyStore.Entry and KeyStore.ProtectionParameter
 * objects.
 * @author fran
 */
public class JCEKSStoreEntryExample implements java.io.Serializable {
    private static final long serialVersionUID = -1L;
    private static final String _NAME = JCEKSStoreEntryExample.class.getName();
    ...
    public static KeyStore createKeyStore() throws Exception {
        KeyStore store = KeyStore.getInstance(CryptoDefs.KeyStoreType.JCEKS.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        store = KeyStore.getInstance(CryptoDefs.KeyStoreType.JCEKS.getName());
