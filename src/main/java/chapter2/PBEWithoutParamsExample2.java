 ...
 * @author fran
 */
public class PBEWithoutParamsExample2 {
     ...
     */
    public PBEWithoutParamsExample2() {}
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Encrypt
        String transform = CryptoDefs.getTransform(CryptoDefs.Algorithm.DESede, CryptoDefs.Mode.CBC, CryptoDefs.Padding.PKCS5);
        ...
        PBEKeySpec       pbeSpec = new PBEKeySpec(password, salt, iterationCount, 128); //OJO
        SecretKeyFactory keyFact = SecretKeyFactory.getInstance(CryptoDefs.Algorithm.PBEWithSHAAnd2_KeyTripleDES_CBC.getName(), CryptoDefs.Provider.BC.getName());
        Key              sKey    = keyFact.generateSecret(pbeSpec);

        Cipher cDec = Cipher.getInstance(CryptoDefs.Algorithm.PBEWithSHAAnd2_KeyTripleDES_CBC.getName(), CryptoDefs.Provider.BC.getName());

        cDec.init(Cipher.DECRYPT_MODE, sKey); //OJO
